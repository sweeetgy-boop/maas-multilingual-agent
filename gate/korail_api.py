...
작업 0 실측 결과 (2026-08-31 기준)
  ...
  - **미래 데이터가 없다.** 이것이 이 모듈의 용도를 결정한다.
      RunPlan2 cond[run_ymd::GTE]=20260830 →  814
      RunPlan2 cond[run_ymd::GTE]=20260831 →    0   (오늘)
      RunPlan2 cond[run_ymd::GTE]=20260901 →    0   (내일)
    보유 범위는 2026-05 말 ~ 2026-08-30, 약 23,000건/월(≈760편/일).
